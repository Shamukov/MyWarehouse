...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body role="document">
    ...
    <div class="container theme-showcase" role="main">
      ...
      <div class="jumbotron">
        <h1>Поставщик</h1>
        <p>Вы перешли в раздел добавления поставщика. Пожалуйста заполните ниже необходимые поля</p>
      </div>
<body>
	<form action="controller" method="post">
		...
		<p>
			описание<input type="text" class="form-control" name="definition" size="20">
		</p>
		<p>
